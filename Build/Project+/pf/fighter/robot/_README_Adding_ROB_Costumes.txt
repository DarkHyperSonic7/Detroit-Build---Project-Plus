...
To change laser colors for neutral B and Final Smash, tab over to Articles -> Sub Actions, and use the drop-down box above to select an article.  Search for Robo Beam & Diffusion Beam and edit the GFX accordingly.